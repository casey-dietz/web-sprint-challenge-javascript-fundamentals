...
// Because the nestedFunction is the child of the parent function where the variable internal lives. The child can inherit from its parent.
...
const zooAnimals = [
 ...
 function USApop(array){
  const totalPop = array.reduce(function(total, item){
